...
class Af9033Data {
    ...
    static int[][] reg_val_mask_tab(int tuner, boolean ts_mode_serial, boolean ts_mode_parallel, int adc_multiplier) {
        return new int[][] {
         // { reg, value, mask }
            ...
            { 0x00d831, 0x00, 0xff },
            { 0x00d832, 0x00, 0xff },
            { 0x80f985, ts_mode_serial ? 1 : 0, 0x01 },
            { 0x80f986, ts_mode_parallel ? 1 : 0, 0x01 },
            { 0x00d827, 0x00, 0xff },
            { 0x00d829, 0x00, 0xff },
    ...
    final static int[][] clock_adc_lut = {
        { 16384000, 20480000 },
        { 20480000, 20480000 },
        { 36000000, 20250000 },
        { 30000000, 20156250 },
    ...
    final static int[][] qpsk_snr_lut = new int[][] {
        { 0x000000,  0 },
        { 0x0b4771,  0 },
        { 0x0c1aed,  1 },
        { 0x0d0d27,  2 },
    ...
    final static int[][] qam16_snr_lut = new int[][] {
        { 0x000000,  0 },
        { 0x05eb62,  5 },
        { 0x05fecf,  6 },
        { 0x060b80,  7 },
    ...
    final static int[][] qam64_snr_lut = new int[][] {
        { 0x000000,  0 },
        { 0x03109b, 12 },
        { 0x0310d4, 13 },
        { 0x031920, 14 },
 ...
 */
    final static int[][] ofsm_init = new int[][] {
            { 0x800051, 0x01 },
            { 0x800070, 0x0a },
            { 0x80007e, 0x04 },
            { 0x800081, 0x0a },
     ...
     */
    final static int[][] tuner_init_tua9001 = new int[][] {
            { 0x800046, 0x27 },
            { 0x800057, 0x00 },
            { 0x800058, 0x01 },
            { 0x80005f, 0x00 },
     ...
     */
    final static int[][] tuner_init_fc0011 = new int[][] {
            { 0x800046, 0x28 },
            { 0x800057, 0x00 },
            { 0x800058, 0x01 },
            { 0x80005f, 0x00 },
     ...
     */
    final static int[][] tuner_init_fc0012 = new int[][] {
            { 0x800046, 0x2e },
            { 0x800057, 0x00 },
            { 0x800058, 0x01 },
            { 0x800059, 0x01 },
     ...
     */
    final static int[][] tuner_init_mxl5007t = new int[][] {
            { 0x800046, 0x1b },
            { 0x800057, 0x01 },
            { 0x800058, 0x01 },
            { 0x80005f, 0x00 },
     ...
     */
    final static int[][] tuner_init_tda18218 = new int[][] {
            {0x800046, 0xa1},
            {0x800057, 0x01},
            {0x800058, 0x01},
            {0x80005f, 0x00},
     ...
     */
    final static int[][] tuner_init_fc2580 = new int[][] {
            { 0x800046, 0x32 },
            { 0x800057, 0x01 },
            { 0x800058, 0x00 },
            { 0x80005f, 0x00 },
     ...
     */
    final static int[][] ofsm_init_it9135_v1 = new int[][] {
            { 0x800051, 0x01 },
            { 0x800070, 0x0a },
            { 0x80007e, 0x04 },
            { 0x800081, 0x0a },
     ...
     */
    final static int[][] tuner_init_it9135_38 = new int[][] {
            { 0x800043, 0x00 },
            { 0x800046, 0x38 },
            { 0x800051, 0x01 },
            { 0x80005f, 0x00 },
     ...
     */
    final static int[][] tuner_init_it9135_51 = new int[][] {
            { 0x800043, 0x00 },
            { 0x800046, 0x51 },
            { 0x800051, 0x01 },
            { 0x80005f, 0x00 },
     ...
     */
    final static int[][] tuner_init_it9135_52 = new int[][] {
            { 0x800043, 0x00 },
            { 0x800046, 0x52 },
            { 0x800051, 0x01 },
            { 0x80005f, 0x00 },
     ...
     */
    final static int[][] ofsm_init_it9135_v2 = new int[][] {
            { 0x800051, 0x01 },
            { 0x800070, 0x0a },
            { 0x80007e, 0x04 },
            { 0x800081, 0x0a },
     ...
     */
    final static int[][] tuner_init_it9135_60 = new int[][] {
            { 0x800043, 0x00 },
            { 0x800046, 0x60 },
            { 0x800051, 0x01 },
            { 0x80005f, 0x00 },
     ...
     */
    final static int[][] tuner_init_it9135_61 = new int[][] {
            { 0x800043, 0x00 },
            { 0x800046, 0x61 },
            { 0x800051, 0x01 },
            { 0x80005f, 0x00 },
     ...
     */
    final static int[][] tuner_init_it9135_62 = new int[][] {
            { 0x800043, 0x00 },
            { 0x800046, 0x62 },
            { 0x800051, 0x01 },
            { 0x80005f, 0x00 },
