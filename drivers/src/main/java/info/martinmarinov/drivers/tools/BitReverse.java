...
public class BitReverse {
    private final static byte[] BYTE_REV_TABLE = {
    ...
    public static byte bitRev8(byte b) {
        return BYTE_REV_TABLE[b & 0xFF];
    }

    public static short bitRev16(short b) {
        return (short) (((bitRev8((byte) b) & 0xFF) << 8) | (bitRev8((byte) (b >> 8)) & 0xFF));
    }

    public static int bitRev32(int b) {
        return ((bitRev16((short) b) & 0xFFFF) << 16) | (bitRev16((short) (b >> 16)) & 0xFFFF);
    }
}
